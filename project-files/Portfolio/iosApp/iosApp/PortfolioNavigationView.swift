...
struct PortfolioNavigationView : UIViewControllerRepresentable {
    var view: AnyView
    let title: String
    ...
    func makeCoordinator() -> Coordinator {
        return PortfolioNavigationView.Coordinator(parent: self)
    }
    ...
    class Coordinator : NSObject, UISearchBarDelegate {
        var parent: PortfolioNavigationView
        
        init(parent: PortfolioNavigationView) {
            self.parent = parent
        }
